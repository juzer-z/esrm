...
def recalculate_ticket_profitability():
    ...
    frappe.db.sql(
        ...
        set
            ...
            cost_status = case
                when payment_mode = 'IATA'
                then if(ifnull(iata_amount, 0) <= 0, 'Incomplete', 'Complete')
                else if(ifnull(supplier_cost, 0) <= 0, 'Incomplete', 'Complete')
            end
        where docstatus != 2
        """
    )
...
SHORTCUTS = [
    ...
    {"type": "Report", "link_to": "IATA Payment Verification", "label": "IATA Verification", "color": "#0b7285"},
    {"type": "DocType", "link_to": "IATA Settlement", "doc_view": "List", "label": "IATA Settlements", "color": "#c92a2a"},
    {"type": "DocType", "link_to": "IATA Adjustment", "doc_view": "List", "label": "IATA Adjustments", "color": "#e8590c"},
...
LINKS = [
    ...
    {"type": "Link", "label": "IATA Settlement", "link_type": "DocType", "link_to": "IATA Settlement"},
    {"type": "Link", "label": "IATA Adjustment", "link_type": "DocType", "link_to": "IATA Adjustment"},
    ...
    {"type": "Link", "label": "IATA Payment Verification", "link_type": "Report", "link_to": "IATA Payment Verification", "is_query_report": 1, "report_ref_doctype": "Ticket Booking"},
    {"type": "Link", "label": "IATA Settlement Register", "link_type": "Report", "link_to": "IATA Settlement Register", "is_query_report": 1, "report_ref_doctype": "IATA Settlement"},
...
def get_workspace_content():
    return [
        ...
        shortcut("IATA Verification", 3),
        shortcut("IATA Settlements", 3),
        shortcut("IATA Adjustments", 3),
