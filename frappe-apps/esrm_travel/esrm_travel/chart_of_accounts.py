...
ACCOUNT_LEDGERS = [
    ...
    ("Staff Cash Advances", "Advance, Deposit and Pre-Payments", "Receivable"),
...
ACCOUNT_RENAMES = [
    ...
    ("Employee Control Ledger", "Staff Cash Advances"),
    ("Employee Control Ledger/Staff Advance", "Staff Cash Advances"),
