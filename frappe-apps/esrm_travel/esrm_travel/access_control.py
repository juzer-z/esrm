...
AGENT_PERMISSIONS = {
    ...
    "IATA Settlement": dict(
        read=1, write=1, create=1, print=1, report=1, export=1, select=1
    ),
    "IATA Settlement Booking": dict(read=1, write=1, create=1, select=1),
    "IATA Memo": dict(read=1, write=1, create=1, submit=1, print=1, report=1, export=1, select=1),
    "IATA Settlement Memo Link": dict(read=1, write=1, create=1, select=1),
    "IATA Settlement Deposit": dict(read=1, write=1, create=1, select=1),
